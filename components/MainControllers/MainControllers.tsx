...
import { MainControllersProps } from "./interfaces";
...
const MainControllers: FC<MainControllersProps> = ({
  dataTestId = "main-controllers",
}) => {
  const {
    isPlaying,
    setSlider,
  ...
  return (
    <div
      ...
      className="flex flex-col items-center justify-center col-span-7 gap-3"
    >
